...
namespace DS.ScriptableObjects
{
    public class DSDialogueContainerSO : ScriptableObject
    {
        ...
        public List<DSDialogueSO> GetUngroupedStartingDialogues() {

            List<DSDialogueSO> ungroupedStartingDialogues = new List<DSDialogueSO>();

            foreach (DSDialogueSO dialogue in UngroupedDialogues) { 
                if (dialogue.IsStartingDialogue)
                    ungroupedStartingDialogues.Add(dialogue);
            }

            return ungroupedStartingDialogues;
        }
    }
}